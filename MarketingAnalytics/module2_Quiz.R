...
customers_2015$segment[which(customers_2015$recency <= 365*2 & customers_2015$recency > 365*1)] = "warm"
customers_2015$segment[which(customers_2015$recency <= 365)] = "active"
customers_2015$segment[which(customers_2015$segment == "warm" & customers_2015$first_purchase <= 365*2)] = "new_warm"
customers_2015$segment[which(customers_2015$segment == "warm" & customers_2015$amount < 100)] = "warm_low_value"
customers_2015$segment[which(customers_2015$segment == "warm" & customers_2015$amount >= 100)] = "warm_high_value"
customers_2015$segment[which(customers_2015$segment == "active" & customers_2015$first_purchase <= 365)] = "new_active"
# Create two new segments - "newactive high" and "new active low" from "new active"
customers_2015$segment[which(customers_2015$segment == "new_active" & customers_2015$amount < 100)] = "new_active_low"
customers_2015$segment[which(customers_2015$segment == "new_active" & customers_2015$amount >= 100)] = "new_active_high"

customers_2015$segment[which(customers_2015$segment == "active" & customers_2015$amount < 100)] = "active_low_value"
customers_2015$segment[which(customers_2015$segment == "active" & customers_2015$amount >= 100)] = "active_high_value"
...
customers_2015$segment = factor(x = customers_2015$segment, levels = c("inactive", "cold",
                                                                       "warm_high_value", "warm_low_value", "new_warm",
                                                                       "active_high_value", "active_low_value", "new_active_high", "new_active_low"))
...
customers_2014$segment[which(customers_2014$segment == "warm" & customers_2014$first_purchase <= 365*2)] = "new_warm"
customers_2014$segment[which(customers_2014$segment == "warm" & customers_2014$amount < 100)] = "warm_low_value"
customers_2014$segment[which(customers_2014$segment == "warm" & customers_2014$amount >= 100)] = "warm_high_value"
customers_2014$segment[which(customers_2014$segment == "active" & customers_2014$first_purchase <= 365)] = "new_active"
# Create two new segments - "newactive high" and "new active low" from "new active"
customers_2014$segment[which(customers_2014$segment == "new_active" & customers_2014$amount < 100)] = "new_active_low"
customers_2014$segment[which(customers_2014$segment == "new_active" & customers_2014$amount >= 100)] = "new_active_high"


customers_2014$segment[which(customers_2014$segment == "active" & customers_2014$amount < 100)] = "active_low_value"
customers_2014$segment[which(customers_2014$segment == "active" & customers_2014$amount >= 100)] = "active_high_value"
